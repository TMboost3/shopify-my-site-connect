  ...
  return <div className="min-h-screen bg-background font-body">
      ...
      <section className="relative h-[35vh] md:h-[70vh] overflow-hidden">
        ...
        <div className="absolute inset-0 z-20 flex items-end justify-center pb-6 md:pb-20">
          <div className="text-center px-4 animate-fade-up">
            <p className="text-base md:text-2xl text-white font-medium max-w-2xl mx-auto" style={{
      ...
      <section className="py-12 md:py-32 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="space-y-6 md:space-y-8 text-sm md:text-lg leading-relaxed animate-fade-up">
            <h2 className="font-heading text-2xl md:text-4xl font-black tracking-tight mb-6 md:mb-8 text-accent">
              OUR STORY
            </h2>
            ...
            <p className="font-heading text-lg md:text-2xl font-black">
              It's not about the origin. It's about the outcome.
            </p>

            <p className="font-heading text-lg md:text-2xl font-black text-accent">
              Dopeness isn't an image. It's a standard.
            </p>

            <div className="pt-6 md:pt-8">
              <Button size="lg" className="relative bg-accent hover:bg-white hover:text-accent text-white font-heading font-bold px-8 md:px-14 py-5 md:py-7 text-base md:text-xl hover:scale-105 transition-all duration-500 w-full sm:w-auto" asChild>
                <Link to="/shop">
                  SHOP THE COLLECTION
                </Link>
              </Button>
      ...
      {/* Music Section */}
      <section className="py-12 md:py-32 px-4 bg-gradient-to-b from-background via-muted/30 to-background">
        <div className="container mx-auto max-w-6xl">
          <div className="bg-black text-white p-6 md:p-16 rounded-2xl md:rounded-3xl shadow-2xl">
            <div className="max-w-3xl mx-auto space-y-6 md:space-y-8 text-center">
              <h2 className="font-heading text-2xl md:text-5xl font-black tracking-tight">
                THE SOUND
              </h2>
              
              <div className="h-1 w-16 md:w-24 bg-accent mx-auto" />
